...
extern float _vec2_get_attr_x(int vec2);
extern void _vec2_set_attr_x(int vec2, float x);
extern float _vec2_get_attr_y(int vec2);
extern void _vec2_set_attr_y(int vec2, float y);
extern float _vec3_get_attr_x(int vec3);
extern void _vec3_set_attr_x(int vec3, float x);
extern float _vec3_get_attr_y(int vec3);
extern void _vec3_set_attr_y(int vec3, float y);
extern float _vec3_get_attr_z(int vec3);
extern void _vec3_set_attr_z(int vec3, float z);
extern float _vec4_get_attr_x(int vec4);
extern void _vec4_set_attr_x(int vec4, float x);
extern float _vec4_get_attr_y(int vec4);
extern void _vec4_set_attr_y(int vec4, float y);
extern float _vec4_get_attr_z(int vec4);
extern void _vec4_set_attr_z(int vec4, float z);
extern float _vec4_get_attr_w(int vec4);
extern void _vec4_set_attr_w(int vec4, float w);
extern float _quat_get_attr_x(int quat);
extern void _quat_set_attr_x(int quat, float x);
extern float _quat_get_attr_y(int quat);
extern void _quat_set_attr_y(int quat, float y);
extern float _quat_get_attr_z(int quat);
extern void _quat_set_attr_z(int quat, float z);
extern float _quat_get_attr_w(int quat);
extern void _quat_set_attr_w(int quat, float w);
extern float _color_get_attr_r(int color);
extern void _color_set_attr_r(int color, float r);
extern float _color_get_attr_g(int color);
extern void _color_set_attr_g(int color, float g);
extern float _color_get_attr_b(int color);
extern void _color_set_attr_b(int color, float b);
extern float _color_get_attr_a(int color);
extern void _color_set_attr_a(int color, float a);
