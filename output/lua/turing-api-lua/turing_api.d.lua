...
---@return nil
function turing_api.TuringerGameObject.sendMessage(self, method_name) end


---@param self table
---@param csType Type
---@return Component
function turing_api.TuringerGameObject.getComponentInParentByType(self, cs_type) end
...
---@param csType Type
---@return Component
function turing_api.TuringerGameObject.getComponentInChildrenByType(self, cs_type) end
...
---@param results List1
---@return nil
function turing_api.TuringerGameObject.getComponentsByType(self, cs_type, results) end
...
---@param methodName string
---@return nil
function turing_api.TuringerGameObject.broadcastMessage(self, method_name) end
...
---@param methodName string
---@return nil
function turing_api.TuringerGameObject.sendMessageUpwards(self, method_name) end
...
---@return nil
function turing_api.TuringerTransform.lookAt(self, world_position) end
...
---@param z number
---@return table
function turing_api.TuringerTransform.inverseTransformPoint(self, x, y, z) end
...
---@param results List1
---@return nil
function turing_api.TuringerTransform.getComponentsByType(self, cs_type, results) end
...
---@param z number
---@return table
function turing_api.TuringerTransform.transformDirection(self, x, y, z) end
...
---@param angle number
---@return nil
function turing_api.TuringerTransform.rotate(self, axis, angle) end
...
---@param translation table
---@return nil
function turing_api.TuringerTransform.translate(self, translation) end
...
---@param angle number
---@return nil
function turing_api.TuringerTransform.rotateAround(self, axis, angle) end
...
---@param z number
---@return table
function turing_api.TuringerTransform.inverseTransformDirection(self, x, y, z) end
...
---@param z number
---@return table
function turing_api.TuringerTransform.transformVector(self, x, y, z) end
...
---@param z number
---@return table
function turing_api.TuringerTransform.transformPoint(self, x, y, z) end
...
---@return nil
function turing_api.TuringerTransform.rotateRelative(self, axis, angle, relative_to) end
...
---@param z number
---@return table
function turing_api.TuringerTransform.inverseTransformVector(self, x, y, z) end
