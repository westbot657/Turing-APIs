...
TURING_API_EXPORT TuringerGameObject TuringerGameObjectManager::create_object(std::string_view name) {
    return _turinger_game_object_manager__create_object(name.data());
}

TURING_API_EXPORT TuringerGameObject TuringerGameObjectManager::find(std::string_view name) {
    return _turinger_game_object_manager__find(name.data());
}
...
TURING_API_EXPORT TuringerGameObjectManager TuringerGameObjectManager::instance_get() {
    return _turinger_game_object_manager__instance_get(this->opaqu);
}
...
TURING_API_EXPORT void TuringerGameObject::send_message(std::string_view method_name) {
    _turinger_game_object__send_message(this->opaqu, method_name.data());
}

TURING_API_EXPORT Component TuringerGameObject::get_component_in_parent_by_type(Type cs_type) {
    return _turinger_game_object__get_component_in_parent_by_type(this->opaqu, cs_type);
}
...
TURING_API_EXPORT TuringerTransform TuringerGameObject::transform_get() {
    return _turinger_game_object__transform_get(this->opaqu);
}

TURING_API_EXPORT Component TuringerGameObject::get_component_in_children_by_type(Type cs_type) {
    return _turinger_game_object__get_component_in_children_by_type(this->opaqu, cs_type);
}

TURING_API_EXPORT void TuringerGameObject::get_components_by_type(Type cs_type, List1 results) {
...
TURING_API_EXPORT void TuringerGameObject::broadcast_message(std::string_view method_name) {
    _turinger_game_object__broadcast_message(this->opaqu, method_name.data());
}

TURING_API_EXPORT GameObject TuringerGameObject::game_object_get() {
    return _turinger_game_object__game_object_get(this->opaqu);
}
...
TURING_API_EXPORT Component TuringerGameObject::add_component(Type component_type) {
    return _turinger_game_object__add_component(this->opaqu, component_type);
}
...
TURING_API_EXPORT void TuringerGameObject::send_message_upwards(std::string_view method_name) {
    _turinger_game_object__send_message_upwards(this->opaqu, method_name.data());
}

TURING_API_EXPORT bool TuringerGameObject::compare_tag(std::string_view tag) {
    return _turinger_game_object__compare_tag(this->opaqu, tag.data());
}
...
TURING_API_EXPORT void TuringerGameObject::tag_set(std::string_view value) {
    _turinger_game_object__tag_set(this->opaqu, value.data());
}
...
TURING_API_EXPORT Component TuringerGameObject::get_component_at_index(int32_t index) {
    return _turinger_game_object__get_component_at_index(this->opaqu, index);
}

TURING_API_EXPORT std::string TuringerGameObject::tag_get() {
    const char* turing_result = _turinger_game_object__tag_get(this->opaqu);
...
TURING_API_EXPORT std::string TuringerGameObject::name_get() {
    const char* turing_result = _turinger_game_object__name_get(this->opaqu);
    return std::string(turing_result);
}

TURING_API_EXPORT Component TuringerGameObject::get_component_by_type(Type cs_type) {
    return _turinger_game_object__get_component_by_type(this->opaqu, cs_type);
}
...
TURING_API_EXPORT Component TuringerGameObject::get_component_by_name(std::string_view cs_type) {
    return _turinger_game_object__get_component_by_name(this->opaqu, cs_type.data());
}

TURING_API_EXPORT void TuringerGameObject::name_set(std::string_view value) {
    _turinger_game_object__name_set(this->opaqu, value.data());
}
...
TURING_API_EXPORT Component TuringerTransform::get_component_by_type(Type cs_type) {
    return _turinger_transform__get_component_by_type(this->opaqu, cs_type);
}

TURING_API_EXPORT void TuringerTransform::look_at(glm::vec3 world_position) {
...
TURING_API_EXPORT std::string TuringerTransform::tag_get() {
    const char* turing_result = _turinger_transform__tag_get(this->opaqu);
    return std::string(turing_result);
}
...
TURING_API_EXPORT void TuringerTransform::name_set(std::string_view value) {
    _turinger_transform__name_set(this->opaqu, value.data());
}
...
TURING_API_EXPORT glm::vec3 TuringerTransform::inverse_transform_point(float x, float y, float z) {
...
TURING_API_EXPORT Component TuringerTransform::get_component_in_children_by_type(Type t, bool include_inactive) {
    return _turinger_transform__get_component_in_children_by_type(this->opaqu, t, include_inactive);
}

TURING_API_EXPORT Transform TuringerTransform::transform_get() {
    return _turinger_transform__transform_get(this->opaqu);
}
...
TURING_API_EXPORT TuringerTransform TuringerTransform::root_get() {
    return _turinger_transform__root_get(this->opaqu);
}

TURING_API_EXPORT void TuringerTransform::get_components_by_type(Type cs_type, List1 results) {
...
TURING_API_EXPORT IEnumerator TuringerTransform::get_enumerator() {
    return _turinger_transform__get_enumerator(this->opaqu);
}
...
TURING_API_EXPORT TuringerTransform TuringerTransform::get_child(int32_t index) {
    return _turinger_transform__get_child(this->opaqu, index);
}

TURING_API_EXPORT glm::vec3 TuringerTransform::transform_direction(float x, float y, float z) {
...
TURING_API_EXPORT void TuringerTransform::send_message_upwards(std::string_view method_name, Object value, int32_t options) {
    _turinger_transform__send_message_upwards(this->opaqu, method_name.data(), value, options);
}

TURING_API_EXPORT TuringerTransform TuringerTransform::find_child(std::string_view n) {
    return _turinger_transform__find_child(this->opaqu, n.data());
}
...
TURING_API_EXPORT void TuringerTransform::rotate(glm::vec3 axis, float angle) {
...
TURING_API_EXPORT Component TuringerTransform::get_component_in_parent_by_type(Type t, bool include_inactive) {
    return _turinger_transform__get_component_in_parent_by_type(this->opaqu, t, include_inactive);
}
...
TURING_API_EXPORT void TuringerTransform::translate(glm::vec3 translation) {
...
TURING_API_EXPORT void TuringerTransform::broadcast_message(std::string_view method_name, Object parameter, int32_t options) {
    _turinger_transform__broadcast_message(this->opaqu, method_name.data(), parameter, options);
}
...
TURING_API_EXPORT void TuringerTransform::send_message(std::string_view method_name, Object value, int32_t options) {
    _turinger_transform__send_message(this->opaqu, method_name.data(), value, options);
}

TURING_API_EXPORT TuringerTransform TuringerTransform::parent_get() {
    return _turinger_transform__parent_get(this->opaqu);
}
...
TURING_API_EXPORT Component TuringerTransform::get_component_by_name(std::string_view cs_type) {
    return _turinger_transform__get_component_by_name(this->opaqu, cs_type.data());
}
...
TURING_API_EXPORT void TuringerTransform::rotate_around(glm::vec3 axis, float angle) {
...
TURING_API_EXPORT glm::vec3 TuringerTransform::inverse_transform_direction(float x, float y, float z) {
...
TURING_API_EXPORT glm::vec3 TuringerTransform::transform_vector(float x, float y, float z) {
    _turinger_transform__transform_vector(this->opaqu, x, y, z);
    return alg::dequeue_vec3();
}

TURING_API_EXPORT glm::vec3 TuringerTransform::transform_point(float x, float y, float z) {
...
TURING_API_EXPORT void TuringerTransform::rotate_relative(glm::vec3 axis, float angle, int32_t relative_to) {
...
TURING_API_EXPORT TuringerGameObject TuringerTransform::game_object_get() {
    return _turinger_transform__game_object_get(this->opaqu);
}
...
TURING_API_EXPORT std::string TuringerTransform::name_get() {
    const char* turing_result = _turinger_transform__name_get(this->opaqu);
    return std::string(turing_result);
}

TURING_API_EXPORT bool TuringerTransform::compare_tag(std::string_view tag) {
    return _turinger_transform__compare_tag(this->opaqu, tag.data());
}
...
TURING_API_EXPORT TuringerTransform TuringerTransform::find(std::string_view n) {
    return _turinger_transform__find(this->opaqu, n.data());
}

TURING_API_EXPORT void TuringerTransform::tag_set(std::string_view value) {
    _turinger_transform__tag_set(this->opaqu, value.data());
}
...
TURING_API_EXPORT glm::vec3 TuringerTransform::inverse_transform_vector(float x, float y, float z) {
...
TURING_API_EXPORT std::string Xr::get_device_name(int32_t node_int) {
    const char* turing_result = _xr__get_device_name(node_int);
    return std::string(turing_result);
}
...
TURING_API_EXPORT TuringScriptManager Xr::_manager_get() {
    return _xr___manager_get(this->opaqu);
}
// CustomData methods

TURING_API_EXPORT CustomData CustomData::create() {
    return _custom_data__create();
}
...
TURING_API_EXPORT void CustomData::set_int(CustomData custom_data, std::string_view key, int32_t value) {
    _custom_data__set_int(custom_data, key.data(), value);
}

TURING_API_EXPORT void CustomData::set_bool(CustomData custom_data, std::string_view key, bool value) {
    _custom_data__set_bool(custom_data, key.data(), value);
}
