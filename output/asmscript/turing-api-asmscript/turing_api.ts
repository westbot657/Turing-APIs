...
declare function _core_turinger_game_object__send_message(opaqu: u64, method_name: u32, options: i32): void;
@external("env", "_core_turinger_game_object__get_component_in_parent_by_type")
declare function _core_turinger_game_object__get_component_in_parent_by_type(opaqu: u64, cs_type: Type, include_inactive: bool): Component;
@external("env", "_core_turinger_game_object__is_static_get")
declare function _core_turinger_game_object__is_static_get(opaqu: u64): bool;
@external("env", "_core_turinger_game_object__transform_get")
declare function _core_turinger_game_object__transform_get(opaqu: u64): TuringerTransform;
@external("env", "_core_turinger_game_object__get_component_in_children_by_type")
declare function _core_turinger_game_object__get_component_in_children_by_type(opaqu: u64, cs_type: Type, include_inactive: bool): Component;
@external("env", "_get_components_by_type")
declare function _get_components_by_type(opaqu: u64, cs_type: Type): Component;
@external("env", "_core_turinger_game_object__active_set")
declare function _core_turinger_game_object__active_set(opaqu: u64, value: bool): void;
@external("env", "_core_turinger_game_object__broadcast_message")
declare function _core_turinger_game_object__broadcast_message(opaqu: u64, method_name: u32, options: i32): void;
@external("env", "_core_turinger_game_object__game_object_get")
declare function _core_turinger_game_object__game_object_get(opaqu: u64): GameObject;
@external("env", "_core_turinger_game_object__is_static_set")
declare function _core_turinger_game_object__is_static_set(opaqu: u64, value: bool): void;
@external("env", "_core_turinger_game_object__add_component")
declare function _core_turinger_game_object__add_component(opaqu: u64, component_type: Type): Component;
@external("env", "_core_turinger_game_object__hide_flags_set")
declare function _core_turinger_game_object__hide_flags_set(opaqu: u64, value: i32): void;
@external("env", "_core_turinger_game_object__send_message_upwards")
declare function _core_turinger_game_object__send_message_upwards(opaqu: u64, method_name: u32, options: i32): void;
@external("env", "_core_turinger_game_object__compare_tag")
declare function _core_turinger_game_object__compare_tag(opaqu: u64, tag: u32): bool;
@external("env", "_core_turinger_game_object__hide_flags_get")
declare function _core_turinger_game_object__hide_flags_get(opaqu: u64): i32;
@external("env", "_core_turinger_game_object__tag_set")
declare function _core_turinger_game_object__tag_set(opaqu: u64, value: u32): void;
@external("env", "_core_turinger_game_object__get_instance_id")
declare function _core_turinger_game_object__get_instance_id(opaqu: u64): i32;
@external("env", "_core_turinger_game_object__layer_get")
declare function _core_turinger_game_object__layer_get(opaqu: u64): i32;
...
declare function _core_turinger_game_object__layer_set(opaqu: u64, value: i32): void;
@external("env", "_core_turinger_game_object__set_active_recursively")
declare function _core_turinger_game_object__set_active_recursively(opaqu: u64, state: bool): void;
@external("env", "_core_turinger_game_object__get_component_index")
declare function _core_turinger_game_object__get_component_index(opaqu: u64, component: Component): i32;
@external("env", "_core_turinger_game_object__get_component_count")
declare function _core_turinger_game_object__get_component_count(opaqu: u64): i32;
@external("env", "_core_turinger_game_object__get_component_at_index")
declare function _core_turinger_game_object__get_component_at_index(opaqu: u64, index: i32): Component;
@external("env", "_core_turinger_game_object__tag_get")
declare function _core_turinger_game_object__tag_get(opaqu: u64): u32;
@external("env", "_core_turinger_game_object__active_self_get")
declare function _core_turinger_game_object__active_self_get(opaqu: u64): bool;
@external("env", "_core_turinger_game_object__name_get")
declare function _core_turinger_game_object__name_get(opaqu: u64): u32;
@external("env", "_core_turinger_game_object__get_component_by_type")
declare function _core_turinger_game_object__get_component_by_type(opaqu: u64, cs_type: Type): Component;
@external("env", "_core_turinger_game_object__active_in_hierarchy_get")
declare function _core_turinger_game_object__active_in_hierarchy_get(opaqu: u64): bool;
@external("env", "_core_turinger_game_object__set_active")
declare function _core_turinger_game_object__set_active(opaqu: u64, value: bool): void;
@external("env", "_core_turinger_game_object__active_get")
declare function _core_turinger_game_object__active_get(opaqu: u64): bool;
@external("env", "_core_turinger_game_object__get_component_by_name")
declare function _core_turinger_game_object__get_component_by_name(opaqu: u64, cs_type: u32): Component;
@external("env", "_core_turinger_game_object__name_set")
declare function _core_turinger_game_object__name_set(opaqu: u64, value: u32): void;
@external("env", "_core_turinger_game_object__scene_culling_mask_get")
declare function _core_turinger_game_object__scene_culling_mask_get(opaqu: u64): u64;
@external("env", "_core_turinger_game_object_manager__create_object")
declare function _core_turinger_game_object_manager__create_object(name: u32): TuringerGameObject;
@external("env", "_core_turinger_game_object_manager__find")
declare function _core_turinger_game_object_manager__find(name: u32): TuringerGameObject;
@external("env", "_core_turinger_game_object_manager__destroy_object")
declare function _core_turinger_game_object_manager__destroy_object(listener: TuringerGameObject): void;

@external("env", "_core_turinger_game_object_manager__instance_get")
declare function _core_turinger_game_object_manager__instance_get(opaqu: u64): TuringerGameObjectManager;
@external("env", "_core_custom_data__create")
declare function _core_custom_data__create(): CustomData;
@external("env", "_list_create")
declare function _list_create(): List;
@external("env", "_core_custom_data__set_string")
declare function _core_custom_data__set_string(custom_data: CustomData, key: u32, value: u32): void;
@external("env", "_core_custom_data__set_custom_data")
declare function _core_custom_data__set_custom_data(custom_data: CustomData, key: u32, value: CustomData): void;
@external("env", "_core_custom_data__list_add_string")
declare function _core_custom_data__list_add_string(list: List1, value: u32): void;
@external("env", "_core_custom_data__set_custom_data_list")
declare function _core_custom_data__set_custom_data_list(custom_data: CustomData, key: u32, value: List1): void;
@external("env", "_core_custom_data__set_float")
declare function _core_custom_data__set_float(custom_data: CustomData, key: u32, value: f32): void;
@external("env", "_core_custom_data__list_add_int")
declare function _core_custom_data__list_add_int(list: List1, value: i32): void;
@external("env", "_core_custom_data__list_add_bool")
declare function _core_custom_data__list_add_bool(list: List1, value: bool): void;
@external("env", "_core_custom_data__set_int")
declare function _core_custom_data__set_int(custom_data: CustomData, key: u32, value: i32): void;
@external("env", "_core_custom_data__set_bool")
declare function _core_custom_data__set_bool(custom_data: CustomData, key: u32, value: bool): void;
@external("env", "_core_custom_data__list_add_custom_data_list")
declare function _core_custom_data__list_add_custom_data_list(list: List1, value: List1): void;
@external("env", "_core_custom_data__list_add_float")
declare function _core_custom_data__list_add_float(list: List1, value: f32): void;
@external("env", "_core_custom_data__list_add_custom_data")
declare function _core_custom_data__list_add_custom_data(list: List1, value: CustomData): void;

@external("env", "_core_gc_helper__create")
declare function _core_gc_helper__create(): GCHelper;

@external("env", "_core_gc_helper__wasm_garbage_collect")
declare function _core_gc_helper__wasm_garbage_collect(opaqu: u64): void;
@external("env", "_core_gc_helper__dispose")
declare function _core_gc_helper__dispose(opaqu: u64): void;
@external("env", "_core_gc_helper__invalidate_all_handles")
declare function _core_gc_helper__invalidate_all_handles(opaqu: u64): void;
@external("env", "_core_note_manager__add_obstacle")
declare function _core_note_manager__add_obstacle(beat: f32, duration: f32, line: i32, layer: i32, width: i32, height: i32, custom_data: CustomData): void;
@external("env", "_core_note_manager__add_color_note")
declare function _core_note_manager__add_color_note(beat: f32, line: i32, layer: i32, color: i32, cut_direction: i32, custom_data: CustomData): void;
...
declare function _core_note_manager__add_bomb_note(beat: f32, line: i32, layer: i32, custom_data: CustomData): void;
...
declare function _core_xr___manager_get(opaqu: u64): TuringScriptManager;

@external("env", "_core_turinger_transform__get_component_by_type")
declare function _core_turinger_transform__get_component_by_type(opaqu: u64, cs_type: Type): Component;
@external("env", "_core_turinger_transform__look_at")
declare function _core_turinger_transform__look_at(opaqu: u64, target: TuringerTransform, world_up: u32): void;
@external("env", "_core_turinger_transform__get_instance_id")
declare function _core_turinger_transform__get_instance_id(opaqu: u64): i32;
@external("env", "_core_turinger_transform__tag_get")
declare function _core_turinger_transform__tag_get(opaqu: u64): u32;
@external("env", "_core_turinger_transform__local_euler_angles_get")
declare function _core_turinger_transform__local_euler_angles_get(opaqu: u64): u32;
@external("env", "_core_turinger_transform__rotation_get")
declare function _core_turinger_transform__rotation_get(opaqu: u64): u32;
@external("env", "_core_turinger_transform__world_to_local_matrix_get")
declare function _core_turinger_transform__world_to_local_matrix_get(opaqu: u64): u32;
@external("env", "_core_turinger_transform__hierarchy_count_get")
declare function _core_turinger_transform__hierarchy_count_get(opaqu: u64): i32;
@external("env", "_get_components_in_children_by_type")
...
declare function _core_turinger_transform__name_set(opaqu: u64, value: u32): void;
@external("env", "_core_turinger_transform__local_rotation_get")
declare function _core_turinger_transform__local_rotation_get(opaqu: u64): u32;
@external("env", "_core_turinger_transform__detach_children")
declare function _core_turinger_transform__detach_children(opaqu: u64): void;
@external("env", "_core_turinger_transform__inverse_transform_point")
declare function _core_turinger_transform__inverse_transform_point(opaqu: u64, position: u32): u32;
@external("env", "_core_turinger_transform__get_component_in_children_by_type")
declare function _core_turinger_transform__get_component_in_children_by_type(opaqu: u64, t: Type, include_inactive: bool): Component;
@external("env", "_core_turinger_transform__transform_get")
declare function _core_turinger_transform__transform_get(opaqu: u64): Transform;
@external("env", "_core_turinger_transform__lossy_scale_get")
declare function _core_turinger_transform__lossy_scale_get(opaqu: u64): u32;
@external("env", "_core_turinger_transform__root_get")
declare function _core_turinger_transform__root_get(opaqu: u64): TuringerTransform;
@external("env", "_get_components_by_type")
declare function _get_components_by_type(opaqu: u64, cs_type: Type): Component;
@external("env", "_core_turinger_transform__get_enumerator")
declare function _core_turinger_transform__get_enumerator(opaqu: u64): IEnumerator;
@external("env", "_core_turinger_transform__local_scale_set")
declare function _core_turinger_transform__local_scale_set(opaqu: u64, value: u32): void;
@external("env", "_core_turinger_transform__child_count_get")
declare function _core_turinger_transform__child_count_get(opaqu: u64): i32;
@external("env", "_core_turinger_transform__parent_set")
declare function _core_turinger_transform__parent_set(opaqu: u64, value: TuringerTransform): void;
@external("env", "_core_turinger_transform__get_child")
declare function _core_turinger_transform__get_child(opaqu: u64, index: i32): TuringerTransform;
@external("env", "_core_turinger_transform__transform_direction")
declare function _core_turinger_transform__transform_direction(opaqu: u64, direction: u32): u32;
@external("env", "_core_turinger_transform__has_changed_set")
declare function _core_turinger_transform__has_changed_set(opaqu: u64, value: bool): void;
@external("env", "_core_turinger_transform__send_message_upwards")
declare function _core_turinger_transform__send_message_upwards(opaqu: u64, method_name: u32, value: Object, options: i32): void;
@external("env", "_core_turinger_transform__find_child")
declare function _core_turinger_transform__find_child(opaqu: u64, n: u32): TuringerTransform;
@external("env", "_get_components_in_parent_by_type")
...
declare function _core_turinger_transform__rotate(opaqu: u64, eulers: u32): void;
@external("env", "_core_turinger_transform__has_changed_get")
declare function _core_turinger_transform__has_changed_get(opaqu: u64): bool;
@external("env", "_core_turinger_transform__local_position_get")
declare function _core_turinger_transform__local_position_get(opaqu: u64): u32;
@external("env", "_core_turinger_transform__translate_relative")
declare function _core_turinger_transform__translate_relative(opaqu: u64, translation: u32, relative_to: TuringerTransform): void;
@external("env", "_core_turinger_transform__local_euler_angles_set")
declare function _core_turinger_transform__local_euler_angles_set(opaqu: u64, value: u32): void;
@external("env", "_core_turinger_transform__set_local_position_and_rotation")
declare function _core_turinger_transform__set_local_position_and_rotation(opaqu: u64, local_position: u32, local_rotation: u32): void;
@external("env", "_core_turinger_transform__forward_get")
declare function _core_turinger_transform__forward_get(opaqu: u64): u32;
@external("env", "_core_turinger_transform__get_sibling_index")
declare function _core_turinger_transform__get_sibling_index(opaqu: u64): i32;
@external("env", "_core_turinger_transform__get_component_in_parent_by_type")
declare function _core_turinger_transform__get_component_in_parent_by_type(opaqu: u64, t: Type, include_inactive: bool): Component;
@external("env", "_core_turinger_transform__up_get")
declare function _core_turinger_transform__up_get(opaqu: u64): u32;
@external("env", "_core_turinger_transform__get_component_index")
declare function _core_turinger_transform__get_component_index(opaqu: u64): i32;
@external("env", "_core_turinger_transform__rotate_around_local")
declare function _core_turinger_transform__rotate_around_local(opaqu: u64, axis: u32, angle: f32): void;
@external("env", "_core_turinger_transform__translate")
declare function _core_turinger_transform__translate(opaqu: u64, translation: u32, relative_to: i32): void;
@external("env", "_core_turinger_transform__broadcast_message")
declare function _core_turinger_transform__broadcast_message(opaqu: u64, method_name: u32, parameter: Object, options: i32): void;
@external("env", "_core_turinger_transform__euler_angles_set")
declare function _core_turinger_transform__euler_angles_set(opaqu: u64, value: u32): void;
@external("env", "_core_turinger_transform__send_message")
declare function _core_turinger_transform__send_message(opaqu: u64, method_name: u32, value: Object, options: i32): void;
@external("env", "_core_turinger_transform__parent_get")
declare function _core_turinger_transform__parent_get(opaqu: u64): TuringerTransform;
@external("env", "_core_turinger_transform__local_to_world_matrix_get")
declare function _core_turinger_transform__local_to_world_matrix_get(opaqu: u64): u32;
@external("env", "_core_turinger_transform__get_component_by_name")
declare function _core_turinger_transform__get_component_by_name(opaqu: u64, cs_type: u32): Component;
@external("env", "_core_turinger_transform__set_parent")
declare function _core_turinger_transform__set_parent(opaqu: u64, parent: TuringerTransform, world_position_stays: bool): void;
@external("env", "_core_turinger_transform__rotate_around")
declare function _core_turinger_transform__rotate_around(opaqu: u64, point: u32, axis: u32, angle: f32): void;
@external("env", "_core_turinger_transform__hierarchy_capacity_set")
declare function _core_turinger_transform__hierarchy_capacity_set(opaqu: u64, value: i32): void;
@external("env", "_core_turinger_transform__up_set")
declare function _core_turinger_transform__up_set(opaqu: u64, value: u32): void;
@external("env", "_core_turinger_transform__inverse_transform_direction")
declare function _core_turinger_transform__inverse_transform_direction(opaqu: u64, direction: u32): u32;
@external("env", "_core_turinger_transform__local_scale_get")
declare function _core_turinger_transform__local_scale_get(opaqu: u64): u32;
@external("env", "_core_turinger_transform__transform_vector")
declare function _core_turinger_transform__transform_vector(opaqu: u64, vector: u32): u32;
@external("env", "_core_turinger_transform__transform_point")
declare function _core_turinger_transform__transform_point(opaqu: u64, position: u32): u32;
@external("env", "_core_turinger_transform__euler_angles_get")
declare function _core_turinger_transform__euler_angles_get(opaqu: u64): u32;
@external("env", "_core_turinger_transform__is_child_of")
declare function _core_turinger_transform__is_child_of(opaqu: u64, parent: TuringerTransform): bool;
@external("env", "_core_turinger_transform__right_set")
declare function _core_turinger_transform__right_set(opaqu: u64, value: u32): void;
@external("env", "_core_turinger_transform__get_child_count")
declare function _core_turinger_transform__get_child_count(opaqu: u64): i32;
@external("env", "_core_turinger_transform__hide_flags_get")
declare function _core_turinger_transform__hide_flags_get(opaqu: u64): i32;
@external("env", "_core_turinger_transform__rotate_relative")
declare function _core_turinger_transform__rotate_relative(opaqu: u64, eulers: u32, relative_to: i32): void;
@external("env", "_core_turinger_transform__rotation_set")
declare function _core_turinger_transform__rotation_set(opaqu: u64, value: u32): void;
@external("env", "_core_turinger_transform__game_object_get")
declare function _core_turinger_transform__game_object_get(opaqu: u64): TuringerGameObject;
@external("env", "_core_turinger_transform__hierarchy_capacity_get")
declare function _core_turinger_transform__hierarchy_capacity_get(opaqu: u64): i32;
@external("env", "_core_turinger_transform__set_as_first_sibling")
declare function _core_turinger_transform__set_as_first_sibling(opaqu: u64): void;
@external("env", "_core_turinger_transform__right_get")
declare function _core_turinger_transform__right_get(opaqu: u64): u32;
@external("env", "_core_turinger_transform__local_position_set")
declare function _core_turinger_transform__local_position_set(opaqu: u64, value: u32): void;
@external("env", "_core_turinger_transform__forward_set")
declare function _core_turinger_transform__forward_set(opaqu: u64, value: u32): void;
@external("env", "_core_turinger_transform__name_get")
declare function _core_turinger_transform__name_get(opaqu: u64): u32;
@external("env", "_core_turinger_transform__compare_tag")
declare function _core_turinger_transform__compare_tag(opaqu: u64, tag: u32): bool;
@external("env", "_core_turinger_transform__set_as_last_sibling")
declare function _core_turinger_transform__set_as_last_sibling(opaqu: u64): void;
@external("env", "_core_turinger_transform__position_get")
declare function _core_turinger_transform__position_get(opaqu: u64): u32;
@external("env", "_core_turinger_transform__set_sibling_index")
declare function _core_turinger_transform__set_sibling_index(opaqu: u64, index: i32): void;
@external("env", "_core_turinger_transform__position_set")
declare function _core_turinger_transform__position_set(opaqu: u64, value: u32): void;
@external("env", "_core_turinger_transform__hide_flags_set")
declare function _core_turinger_transform__hide_flags_set(opaqu: u64, value: i32): void;
@external("env", "_core_turinger_transform__set_position_and_rotation")
declare function _core_turinger_transform__set_position_and_rotation(opaqu: u64, position: u32, rotation: u32): void;
@external("env", "_core_turinger_transform__find")
declare function _core_turinger_transform__find(opaqu: u64, n: u32): TuringerTransform;
@external("env", "_core_turinger_transform__tag_set")
declare function _core_turinger_transform__tag_set(opaqu: u64, value: u32): void;
@external("env", "_core_turinger_transform__local_rotation_set")
declare function _core_turinger_transform__local_rotation_set(opaqu: u64, value: u32): void;
@external("env", "_core_turinger_transform__inverse_transform_vector")
declare function _core_turinger_transform__inverse_transform_vector(opaqu: u64, vector: u32): u32;export function _turing_api_semver(): u64 {
...
class TuringerGameObject {
    ...
    public send_message(method_name: string, options: i32): void {
        ...
        _core_turinger_game_object__send_message(this.opaqu, turing_handle_method_name, options);
    }

    public get_component_in_parent_by_type(cs_type: Type, include_inactive: bool): Component {
        let turing_result = _core_turinger_game_object__get_component_in_parent_by_type(this.opaqu, cs_type, include_inactive);
        return new Component(turing_result);
    }
    ...
    public transform_get(): TuringerTransform {
        let turing_result = _core_turinger_game_object__transform_get(this.opaqu);
    ...
    public get_component_in_children_by_type(cs_type: Type, include_inactive: bool): Component {
        let turing_result = _core_turinger_game_object__get_component_in_children_by_type(this.opaqu, cs_type, include_inactive);
        return new Component(turing_result);
    }

    public get_components_by_type(cs_type: Type): Component {
        let turing_result = _get_components_by_type(this.opaqu, cs_type);
        return new Component(turing_result);
    }
    ...
    public broadcast_message(method_name: string, options: i32): void {
        let turing_handle_method_name = String.UTF8.encode(method_name, true);
        _core_turinger_game_object__broadcast_message(this.opaqu, turing_handle_method_name, options);
    }

    public game_object_get(): GameObject {
        let turing_result = _core_turinger_game_object__game_object_get(this.opaqu);
    ...
    public add_component(component_type: Type): Component {
        let turing_result = _core_turinger_game_object__add_component(this.opaqu, component_type);
        return new Component(turing_result);
    }
    ...
    public send_message_upwards(method_name: string, options: i32): void {
        let turing_handle_method_name = String.UTF8.encode(method_name, true);
        _core_turinger_game_object__send_message_upwards(this.opaqu, turing_handle_method_name, options);
    }

    public compare_tag(tag: string): bool {
        let turing_handle_tag = String.UTF8.encode(tag, true);
        return _core_turinger_game_object__compare_tag(this.opaqu, turing_handle_tag);
    }
    ...
    public tag_set(value: string): void {
        ...
        _core_turinger_game_object__tag_set(this.opaqu, turing_handle_value);
    }
    ...
    public get_component_at_index(index: i32): Component {
        let turing_result = _core_turinger_game_object__get_component_at_index(this.opaqu, index);
        return new Component(turing_result);
    }

    public tag_get(): string {
        let turing_result = _core_turinger_game_object__tag_get(this.opaqu);
    ...
    public name_get(): string {
        let turing_result = _core_turinger_game_object__name_get(this.opaqu);
        let turing_str = heap.alloc(usize(turing_result));
        _host_strcpy(u32(turing_str), turing_result);
        let turing_output = String.UTF8.decode(turing_str, true);
        heap.free(turing_str);
    ...
    public get_component_by_type(cs_type: Type): Component {
        let turing_result = _core_turinger_game_object__get_component_by_type(this.opaqu, cs_type);
        return new Component(turing_result);
    }
    ...
    public get_component_by_name(cs_type: string): Component {
        ...
        let turing_result = _core_turinger_game_object__get_component_by_name(this.opaqu, turing_handle_cs_type);
        return new Component(turing_result);
    }

    public name_set(value: string): void {
        let turing_handle_value = String.UTF8.encode(value, true);
        _core_turinger_game_object__name_set(this.opaqu, turing_handle_value);
    }
...
class TuringerGameObjectManager {
    ...
    public instance_get(): TuringerGameObjectManager {
        let turing_result = _core_turinger_game_object_manager__instance_get(this.opaqu);
...
class CustomData {
    ...
    public static set_string(custom_data: CustomData, key: string, value: string): void {
        ...
        let turing_handle_value = String.UTF8.encode(value, true);
        _core_custom_data__set_string(custom_data, turing_handle_key, turing_handle_value);
    }

    public static set_custom_data(custom_data: CustomData, key: string, value: CustomData): void {
        let turing_handle_key = String.UTF8.encode(key, true);
        _core_custom_data__set_custom_data(custom_data, turing_handle_key, value);
    }

    public static list_add_string(list: List1, value: string): void {
        let turing_handle_value = String.UTF8.encode(value, true);
        _core_custom_data__list_add_string(list, turing_handle_value);
    }

    public static set_custom_data_list(custom_data: CustomData, key: string, value: List1): void {
        let turing_handle_key = String.UTF8.encode(key, true);
        _core_custom_data__set_custom_data_list(custom_data, turing_handle_key, value);
    }

    public static set_float(custom_data: CustomData, key: string, value: f32): void {
        let turing_handle_key = String.UTF8.encode(key, true);
        _core_custom_data__set_float(custom_data, turing_handle_key, value);
    }
    ...
    public static set_int(custom_data: CustomData, key: string, value: i32): void {
        let turing_handle_key = String.UTF8.encode(key, true);
        _core_custom_data__set_int(custom_data, turing_handle_key, value);
    }

    public static set_bool(custom_data: CustomData, key: string, value: bool): void {
        let turing_handle_key = String.UTF8.encode(key, true);
        _core_custom_data__set_bool(custom_data, turing_handle_key, value);
    }
...
class Xr {
    ...
    public _manager_get(): TuringScriptManager {
        let turing_result = _core_xr___manager_get(this.opaqu);
...
class TuringerTransform {
    ...
    public get_component_by_type(cs_type: Type): Component {
        let turing_result = _core_turinger_transform__get_component_by_type(this.opaqu, cs_type);
        return new Component(turing_result);
    }

    public look_at(target: TuringerTransform, world_up: Vec3): void {
        let turing_handle_world_up = enqueue_vec3(world_up);
        _core_turinger_transform__look_at(this.opaqu, target, turing_handle_world_up);
    }
    ...
    public tag_get(): string {
        let turing_result = _core_turinger_transform__tag_get(this.opaqu);
        let turing_str = heap.alloc(usize(turing_result));
        _host_strcpy(u32(turing_str), turing_result);
        let turing_output = String.UTF8.decode(turing_str, true);
        heap.free(turing_str);
    ...
    public name_set(value: string): void {
        let turing_handle_value = String.UTF8.encode(value, true);
        _core_turinger_transform__name_set(this.opaqu, turing_handle_value);
    }
    ...
    public inverse_transform_point(position: Vec3): Vec3 {
        ...
        _core_turinger_transform__inverse_transform_point(this.opaqu, turing_handle_position);
        return dequeue_vec3();
    }

    public get_component_in_children_by_type(t: Type, include_inactive: bool): Component {
        let turing_result = _core_turinger_transform__get_component_in_children_by_type(this.opaqu, t, include_inactive);
        return new Component(turing_result);
    }

    public transform_get(): Transform {
        let turing_result = _core_turinger_transform__transform_get(this.opaqu);
    ...
    public root_get(): TuringerTransform {
        let turing_result = _core_turinger_transform__root_get(this.opaqu);
        return new TuringerTransform(turing_result);
    }
    ...
    public get_enumerator(): IEnumerator {
        let turing_result = _core_turinger_transform__get_enumerator(this.opaqu);
        return new IEnumerator(turing_result);
    }

    public local_scale_set(value: Vec3): void {
        let turing_handle_value = enqueue_vec3(value);
        _core_turinger_transform__local_scale_set(this.opaqu, turing_handle_value);
    }
    ...
    public get_child(index: i32): TuringerTransform {
        let turing_result = _core_turinger_transform__get_child(this.opaqu, index);
        return new TuringerTransform(turing_result);
    }

    public transform_direction(direction: Vec3): Vec3 {
        let turing_handle_direction = enqueue_vec3(direction);
        _core_turinger_transform__transform_direction(this.opaqu, turing_handle_direction);
        return dequeue_vec3();
    }
    ...
    public send_message_upwards(method_name: string, value: Object, options: i32): void {
        let turing_handle_method_name = String.UTF8.encode(method_name, true);
        _core_turinger_transform__send_message_upwards(this.opaqu, turing_handle_method_name, value, options);
    }

    public find_child(n: string): TuringerTransform {
        let turing_handle_n = String.UTF8.encode(n, true);
        let turing_result = _core_turinger_transform__find_child(this.opaqu, turing_handle_n);
        return new TuringerTransform(turing_result);
    }
    ...
    public rotate(eulers: Vec3): void {
        let turing_handle_eulers = enqueue_vec3(eulers);
        _core_turinger_transform__rotate(this.opaqu, turing_handle_eulers);
    }
    ...
    public translate_relative(translation: Vec3, relative_to: TuringerTransform): void {
        ...
        _core_turinger_transform__translate_relative(this.opaqu, turing_handle_translation, relative_to);
    }

    public local_euler_angles_set(value: Vec3): void {
        let turing_handle_value = enqueue_vec3(value);
        _core_turinger_transform__local_euler_angles_set(this.opaqu, turing_handle_value);
    }
    ...
    public set_local_position_and_rotation(local_position: Vec3, local_rotation: Quat): void {
        ...
        _core_turinger_transform__set_local_position_and_rotation(this.opaqu, turing_handle_local_position, turing_handle_local_rotation);
    }
    ...
    public get_component_in_parent_by_type(t: Type, include_inactive: bool): Component {
        let turing_result = _core_turinger_transform__get_component_in_parent_by_type(this.opaqu, t, include_inactive);
        return new Component(turing_result);
    }
    ...
    public rotate_around_local(axis: Vec3, angle: f32): void {
        ...
        _core_turinger_transform__rotate_around_local(this.opaqu, turing_handle_axis, angle);
    }

    public translate(translation: Vec3, relative_to: i32): void {
        let turing_handle_translation = enqueue_vec3(translation);
        _core_turinger_transform__translate(this.opaqu, turing_handle_translation, relative_to);
    }

    public broadcast_message(method_name: string, parameter: Object, options: i32): void {
        let turing_handle_method_name = String.UTF8.encode(method_name, true);
        _core_turinger_transform__broadcast_message(this.opaqu, turing_handle_method_name, parameter, options);
    }

    public euler_angles_set(value: Vec3): void {
        let turing_handle_value = enqueue_vec3(value);
        _core_turinger_transform__euler_angles_set(this.opaqu, turing_handle_value);
    }

    public send_message(method_name: string, value: Object, options: i32): void {
        let turing_handle_method_name = String.UTF8.encode(method_name, true);
        _core_turinger_transform__send_message(this.opaqu, turing_handle_method_name, value, options);
    }

    public parent_get(): TuringerTransform {
        let turing_result = _core_turinger_transform__parent_get(this.opaqu);
        return new TuringerTransform(turing_result);
    }
    ...
    public get_component_by_name(cs_type: string): Component {
        let turing_handle_cs_type = String.UTF8.encode(cs_type, true);
        let turing_result = _core_turinger_transform__get_component_by_name(this.opaqu, turing_handle_cs_type);
        return new Component(turing_result);
    }
    ...
    public rotate_around(point: Vec3, axis: Vec3, angle: f32): void {
        let turing_handle_point = enqueue_vec3(point);
        let turing_handle_axis = enqueue_vec3(axis);
        _core_turinger_transform__rotate_around(this.opaqu, turing_handle_point, turing_handle_axis, angle);
    }
    ...
    public up_set(value: Vec3): void {
        let turing_handle_value = enqueue_vec3(value);
        _core_turinger_transform__up_set(this.opaqu, turing_handle_value);
    }

    public inverse_transform_direction(direction: Vec3): Vec3 {
        let turing_handle_direction = enqueue_vec3(direction);
        _core_turinger_transform__inverse_transform_direction(this.opaqu, turing_handle_direction);
        return dequeue_vec3();
    }
    ...
    public transform_vector(vector: Vec3): Vec3 {
        let turing_handle_vector = enqueue_vec3(vector);
        _core_turinger_transform__transform_vector(this.opaqu, turing_handle_vector);
        return dequeue_vec3();
    }

    public transform_point(position: Vec3): Vec3 {
        let turing_handle_position = enqueue_vec3(position);
        _core_turinger_transform__transform_point(this.opaqu, turing_handle_position);
        return dequeue_vec3();
    }
    ...
    public right_set(value: Vec3): void {
        let turing_handle_value = enqueue_vec3(value);
        _core_turinger_transform__right_set(this.opaqu, turing_handle_value);
    }
    ...
    public rotate_relative(eulers: Vec3, relative_to: i32): void {
        let turing_handle_eulers = enqueue_vec3(eulers);
        _core_turinger_transform__rotate_relative(this.opaqu, turing_handle_eulers, relative_to);
    }

    public rotation_set(value: Quat): void {
        let turing_handle_value = enqueue_quat(value);
        _core_turinger_transform__rotation_set(this.opaqu, turing_handle_value);
    }

    public game_object_get(): TuringerGameObject {
        let turing_result = _core_turinger_transform__game_object_get(this.opaqu);
        return new TuringerGameObject(turing_result);
    }
    ...
    public local_position_set(value: Vec3): void {
        let turing_handle_value = enqueue_vec3(value);
        _core_turinger_transform__local_position_set(this.opaqu, turing_handle_value);
    }

    public forward_set(value: Vec3): void {
        let turing_handle_value = enqueue_vec3(value);
        _core_turinger_transform__forward_set(this.opaqu, turing_handle_value);
    }

    public name_get(): string {
        let turing_result = _core_turinger_transform__name_get(this.opaqu);
        let turing_str = heap.alloc(usize(turing_result));
        _host_strcpy(u32(turing_str), turing_result);
        let turing_output = String.UTF8.decode(turing_str, true);
        heap.free(turing_str);
    ...
    public compare_tag(tag: string): bool {
        let turing_handle_tag = String.UTF8.encode(tag, true);
        return _core_turinger_transform__compare_tag(this.opaqu, turing_handle_tag);
    }
    ...
    public position_set(value: Vec3): void {
        let turing_handle_value = enqueue_vec3(value);
        _core_turinger_transform__position_set(this.opaqu, turing_handle_value);
    }
    ...
    public set_position_and_rotation(position: Vec3, rotation: Quat): void {
        ...
        _core_turinger_transform__set_position_and_rotation(this.opaqu, turing_handle_position, turing_handle_rotation);
    }

    public find(n: string): TuringerTransform {
        let turing_handle_n = String.UTF8.encode(n, true);
        let turing_result = _core_turinger_transform__find(this.opaqu, turing_handle_n);
        return new TuringerTransform(turing_result);
    }

    public tag_set(value: string): void {
        let turing_handle_value = String.UTF8.encode(value, true);
        _core_turinger_transform__tag_set(this.opaqu, turing_handle_value);
    }

    public local_rotation_set(value: Quat): void {
        let turing_handle_value = enqueue_quat(value);
        _core_turinger_transform__local_rotation_set(this.opaqu, turing_handle_value);
    }

    public inverse_transform_vector(vector: Vec3): Vec3 {
        let turing_handle_vector = enqueue_vec3(vector);
        _core_turinger_transform__inverse_transform_vector(this.opaqu, turing_handle_vector);
        return dequeue_vec3();
    }
}
