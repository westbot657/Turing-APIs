...
void _color_note_set_position(uint64_t opaqu, uint32_t v);
...
uint32_t _color_note_get_orientation(uint64_t opaqu);

uint32_t _color_note_get_transform(uint64_t opaqu);
