...
extern "C" fn _core_log__warn(msg: [*:0]const u8) void;
extern "C" fn _core_log__info(msg: [*:0]const u8) void;
extern "C" fn _core_log__debug(msg: [*:0]const u8) void;
extern "C" fn _core_log__critical(msg: [*:0]const u8) void;
extern "C" fn _get_components_in_parent_by_type(opaqu: u64, cs_type: Type, include_inactive: bool) Component;
extern "C" fn _core_turinger_game_object__send_message(opaqu: u64, method_name: [*:0]const u8, options: i32) void;
extern "C" fn _core_turinger_game_object__get_component_in_parent_by_type(opaqu: u64, cs_type: Type, include_inactive: bool) Component;
extern "C" fn _core_turinger_game_object__is_static_get(opaqu: u64) bool;
extern "C" fn _core_turinger_game_object__transform_get(opaqu: u64) TuringerTransform;
extern "C" fn _core_turinger_game_object__get_component_in_children_by_type(opaqu: u64, cs_type: Type, include_inactive: bool) Component;
extern "C" fn _get_components_by_type(opaqu: u64, cs_type: Type) Component;
extern "C" fn _core_turinger_game_object__active_set(opaqu: u64, value: bool) void;
extern "C" fn _core_turinger_game_object__broadcast_message(opaqu: u64, method_name: [*:0]const u8, options: i32) void;
extern "C" fn _core_turinger_game_object__game_object_get(opaqu: u64) GameObject;
extern "C" fn _core_turinger_game_object__is_static_set(opaqu: u64, value: bool) void;
extern "C" fn _core_turinger_game_object__add_component(opaqu: u64, component_type: Type) Component;
extern "C" fn _core_turinger_game_object__hide_flags_set(opaqu: u64, value: i32) void;
extern "C" fn _core_turinger_game_object__send_message_upwards(opaqu: u64, method_name: [*:0]const u8, options: i32) void;
extern "C" fn _core_turinger_game_object__compare_tag(opaqu: u64, tag: [*:0]const u8) bool;
extern "C" fn _core_turinger_game_object__hide_flags_get(opaqu: u64) i32;
extern "C" fn _core_turinger_game_object__tag_set(opaqu: u64, value: [*:0]const u8) void;
extern "C" fn _core_turinger_game_object__get_instance_id(opaqu: u64) i32;
extern "C" fn _core_turinger_game_object__layer_get(opaqu: u64) i32;
extern "C" fn _get_components_in_children_by_type(opaqu: u64, cs_type: Type, include_inactive: bool) Component;
extern "C" fn _core_turinger_game_object__layer_set(opaqu: u64, value: i32) void;
extern "C" fn _core_turinger_game_object__set_active_recursively(opaqu: u64, state: bool) void;
extern "C" fn _core_turinger_game_object__get_component_index(opaqu: u64, component: Component) i32;
extern "C" fn _core_turinger_game_object__get_component_count(opaqu: u64) i32;
extern "C" fn _core_turinger_game_object__get_component_at_index(opaqu: u64, index: i32) Component;
extern "C" fn _core_turinger_game_object__tag_get(opaqu: u64) u32;
extern "C" fn _core_turinger_game_object__active_self_get(opaqu: u64) bool;
extern "C" fn _core_turinger_game_object__name_get(opaqu: u64) u32;
extern "C" fn _core_turinger_game_object__get_component_by_type(opaqu: u64, cs_type: Type) Component;
extern "C" fn _core_turinger_game_object__active_in_hierarchy_get(opaqu: u64) bool;
extern "C" fn _core_turinger_game_object__set_active(opaqu: u64, value: bool) void;
extern "C" fn _core_turinger_game_object__active_get(opaqu: u64) bool;
extern "C" fn _core_turinger_game_object__get_component_by_name(opaqu: u64, cs_type: [*:0]const u8) Component;
extern "C" fn _core_turinger_game_object__name_set(opaqu: u64, value: [*:0]const u8) void;
extern "C" fn _core_turinger_game_object__scene_culling_mask_get(opaqu: u64) u64;
extern "C" fn _core_turinger_game_object_manager__create_object(name: [*:0]const u8) TuringerGameObject;
extern "C" fn _core_turinger_game_object_manager__find(name: [*:0]const u8) TuringerGameObject;
extern "C" fn _core_turinger_game_object_manager__destroy_object(listener: TuringerGameObject) void;
extern "C" fn _core_turinger_game_object_manager__instance_get(opaqu: u64) TuringerGameObjectManager;
extern "C" fn _core_custom_data__create() CustomData;
extern "C" fn _list_create() List;
extern "C" fn _core_custom_data__set_string(custom_data: CustomData, key: [*:0]const u8, value: [*:0]const u8) void;
extern "C" fn _core_custom_data__set_custom_data(custom_data: CustomData, key: [*:0]const u8, value: CustomData) void;
extern "C" fn _core_custom_data__list_add_string(list: List1, value: [*:0]const u8) void;
extern "C" fn _core_custom_data__set_custom_data_list(custom_data: CustomData, key: [*:0]const u8, value: List1) void;
extern "C" fn _core_custom_data__set_float(custom_data: CustomData, key: [*:0]const u8, value: f32) void;
...
extern "C" fn _core_custom_data__set_int(custom_data: CustomData, key: [*:0]const u8, value: i32) void;
extern "C" fn _core_custom_data__set_bool(custom_data: CustomData, key: [*:0]const u8, value: bool) void;
...
extern "C" fn _core_gc_helper__wasm_garbage_collect(opaqu: u64) void;
extern "C" fn _core_gc_helper__dispose(opaqu: u64) void;
extern "C" fn _core_gc_helper__invalidate_all_handles(opaqu: u64) void;
...
extern "C" fn _core_xr___manager_get(opaqu: u64) TuringScriptManager;
extern "C" fn _core_turinger_transform__get_component_by_type(opaqu: u64, cs_type: Type) Component;
extern "C" fn _core_turinger_transform__look_at(opaqu: u64, target: TuringerTransform, world_up: u32) void;
extern "C" fn _core_turinger_transform__get_instance_id(opaqu: u64) i32;
extern "C" fn _core_turinger_transform__tag_get(opaqu: u64) u32;
extern "C" fn _core_turinger_transform__local_euler_angles_get(opaqu: u64) u32;
extern "C" fn _core_turinger_transform__rotation_get(opaqu: u64) u32;
extern "C" fn _core_turinger_transform__world_to_local_matrix_get(opaqu: u64) u32;
extern "C" fn _core_turinger_transform__hierarchy_count_get(opaqu: u64) i32;
extern "C" fn _get_components_in_children_by_type(opaqu: u64, t: Type, include_inactive: bool) Component;
extern "C" fn _core_turinger_transform__name_set(opaqu: u64, value: [*:0]const u8) void;
extern "C" fn _core_turinger_transform__local_rotation_get(opaqu: u64) u32;
extern "C" fn _core_turinger_transform__detach_children(opaqu: u64) void;
extern "C" fn _core_turinger_transform__inverse_transform_point(opaqu: u64, position: u32) u32;
extern "C" fn _core_turinger_transform__get_component_in_children_by_type(opaqu: u64, t: Type, include_inactive: bool) Component;
extern "C" fn _core_turinger_transform__transform_get(opaqu: u64) Transform;
extern "C" fn _core_turinger_transform__lossy_scale_get(opaqu: u64) u32;
extern "C" fn _core_turinger_transform__root_get(opaqu: u64) TuringerTransform;
extern "C" fn _get_components_by_type(opaqu: u64, cs_type: Type) Component;
extern "C" fn _core_turinger_transform__get_enumerator(opaqu: u64) IEnumerator;
extern "C" fn _core_turinger_transform__local_scale_set(opaqu: u64, value: u32) void;
extern "C" fn _core_turinger_transform__child_count_get(opaqu: u64) i32;
extern "C" fn _core_turinger_transform__parent_set(opaqu: u64, value: TuringerTransform) void;
extern "C" fn _core_turinger_transform__get_child(opaqu: u64, index: i32) TuringerTransform;
extern "C" fn _core_turinger_transform__transform_direction(opaqu: u64, direction: u32) u32;
extern "C" fn _core_turinger_transform__has_changed_set(opaqu: u64, value: bool) void;
extern "C" fn _core_turinger_transform__send_message_upwards(opaqu: u64, method_name: [*:0]const u8, value: Object, options: i32) void;
extern "C" fn _core_turinger_transform__find_child(opaqu: u64, n: [*:0]const u8) TuringerTransform;
extern "C" fn _get_components_in_parent_by_type(opaqu: u64, t: Type, include_inactive: bool) Component;
extern "C" fn _core_turinger_transform__rotate(opaqu: u64, eulers: u32) void;
extern "C" fn _core_turinger_transform__has_changed_get(opaqu: u64) bool;
extern "C" fn _core_turinger_transform__local_position_get(opaqu: u64) u32;
extern "C" fn _core_turinger_transform__translate_relative(opaqu: u64, translation: u32, relative_to: TuringerTransform) void;
extern "C" fn _core_turinger_transform__local_euler_angles_set(opaqu: u64, value: u32) void;
extern "C" fn _core_turinger_transform__set_local_position_and_rotation(opaqu: u64, local_position: u32, local_rotation: u32) void;
extern "C" fn _core_turinger_transform__forward_get(opaqu: u64) u32;
extern "C" fn _core_turinger_transform__get_sibling_index(opaqu: u64) i32;
extern "C" fn _core_turinger_transform__get_component_in_parent_by_type(opaqu: u64, t: Type, include_inactive: bool) Component;
extern "C" fn _core_turinger_transform__up_get(opaqu: u64) u32;
extern "C" fn _core_turinger_transform__get_component_index(opaqu: u64) i32;
extern "C" fn _core_turinger_transform__rotate_around_local(opaqu: u64, axis: u32, angle: f32) void;
extern "C" fn _core_turinger_transform__translate(opaqu: u64, translation: u32, relative_to: i32) void;
extern "C" fn _core_turinger_transform__broadcast_message(opaqu: u64, method_name: [*:0]const u8, parameter: Object, options: i32) void;
extern "C" fn _core_turinger_transform__euler_angles_set(opaqu: u64, value: u32) void;
extern "C" fn _core_turinger_transform__send_message(opaqu: u64, method_name: [*:0]const u8, value: Object, options: i32) void;
extern "C" fn _core_turinger_transform__parent_get(opaqu: u64) TuringerTransform;
extern "C" fn _core_turinger_transform__local_to_world_matrix_get(opaqu: u64) u32;
extern "C" fn _core_turinger_transform__get_component_by_name(opaqu: u64, cs_type: [*:0]const u8) Component;
extern "C" fn _core_turinger_transform__set_parent(opaqu: u64, parent: TuringerTransform, world_position_stays: bool) void;
extern "C" fn _core_turinger_transform__rotate_around(opaqu: u64, point: u32, axis: u32, angle: f32) void;
extern "C" fn _core_turinger_transform__hierarchy_capacity_set(opaqu: u64, value: i32) void;
extern "C" fn _core_turinger_transform__up_set(opaqu: u64, value: u32) void;
extern "C" fn _core_turinger_transform__inverse_transform_direction(opaqu: u64, direction: u32) u32;
extern "C" fn _core_turinger_transform__local_scale_get(opaqu: u64) u32;
extern "C" fn _core_turinger_transform__transform_vector(opaqu: u64, vector: u32) u32;
extern "C" fn _core_turinger_transform__transform_point(opaqu: u64, position: u32) u32;
extern "C" fn _core_turinger_transform__euler_angles_get(opaqu: u64) u32;
extern "C" fn _core_turinger_transform__is_child_of(opaqu: u64, parent: TuringerTransform) bool;
extern "C" fn _core_turinger_transform__right_set(opaqu: u64, value: u32) void;
extern "C" fn _core_turinger_transform__get_child_count(opaqu: u64) i32;
extern "C" fn _core_turinger_transform__hide_flags_get(opaqu: u64) i32;
extern "C" fn _core_turinger_transform__rotate_relative(opaqu: u64, eulers: u32, relative_to: i32) void;
extern "C" fn _core_turinger_transform__rotation_set(opaqu: u64, value: u32) void;
extern "C" fn _core_turinger_transform__game_object_get(opaqu: u64) TuringerGameObject;
extern "C" fn _core_turinger_transform__hierarchy_capacity_get(opaqu: u64) i32;
extern "C" fn _core_turinger_transform__set_as_first_sibling(opaqu: u64) void;
extern "C" fn _core_turinger_transform__right_get(opaqu: u64) u32;
extern "C" fn _core_turinger_transform__local_position_set(opaqu: u64, value: u32) void;
extern "C" fn _core_turinger_transform__forward_set(opaqu: u64, value: u32) void;
extern "C" fn _core_turinger_transform__name_get(opaqu: u64) u32;
extern "C" fn _core_turinger_transform__compare_tag(opaqu: u64, tag: [*:0]const u8) bool;
extern "C" fn _core_turinger_transform__set_as_last_sibling(opaqu: u64) void;
extern "C" fn _core_turinger_transform__position_get(opaqu: u64) u32;
extern "C" fn _core_turinger_transform__set_sibling_index(opaqu: u64, index: i32) void;
extern "C" fn _core_turinger_transform__position_set(opaqu: u64, value: u32) void;
extern "C" fn _core_turinger_transform__hide_flags_set(opaqu: u64, value: i32) void;
extern "C" fn _core_turinger_transform__set_position_and_rotation(opaqu: u64, position: u32, rotation: u32) void;
extern "C" fn _core_turinger_transform__find(opaqu: u64, n: [*:0]const u8) TuringerTransform;
extern "C" fn _core_turinger_transform__tag_set(opaqu: u64, value: [*:0]const u8) void;
extern "C" fn _core_turinger_transform__local_rotation_set(opaqu: u64, value: u32) void;
extern "C" fn _core_turinger_transform__inverse_transform_vector(opaqu: u64, vector: u32) u32;
...
pub const TuringerGameObject = struct {
    ...
    pub fn send_message(self: *const TuringerGameObject, method_name: []const u8, options: i32, allocator: std.mem.Allocator) !void {
        ...
        _core_turinger_game_object__send_message(self.opaqu, turing_handle_method_name.ptr, options);
    }


    pub fn get_component_in_parent_by_type(self: *const TuringerGameObject, cs_type: Type, include_inactive: bool) Component {
        const turing_result = _core_turinger_game_object__get_component_in_parent_by_type(self.opaqu, cs_type, include_inactive);
        return Component{ .opaqu = turing_result };
    }
    ...
    pub fn transform_get(self: *const TuringerGameObject) TuringerTransform {
        const turing_result = _core_turinger_game_object__transform_get(self.opaqu);
    ...
    pub fn get_component_in_children_by_type(self: *const TuringerGameObject, cs_type: Type, include_inactive: bool) Component {
        const turing_result = _core_turinger_game_object__get_component_in_children_by_type(self.opaqu, cs_type, include_inactive);
        return Component{ .opaqu = turing_result };
    }


    pub fn get_components_by_type(self: *const TuringerGameObject, cs_type: Type) Component {
        const turing_result = _get_components_by_type(self.opaqu, cs_type);
        return Component{ .opaqu = turing_result };
    }
    ...
    pub fn broadcast_message(self: *const TuringerGameObject, method_name: []const u8, options: i32, allocator: std.mem.Allocator) !void {
        const turing_handle_method_name = try allocator.dupeZ(u8, method_name);
        defer allocator.free(turing_handle_method_name);
        _core_turinger_game_object__broadcast_message(self.opaqu, turing_handle_method_name.ptr, options);
    }


    pub fn game_object_get(self: *const TuringerGameObject) GameObject {
        const turing_result = _core_turinger_game_object__game_object_get(self.opaqu);
    ...
    pub fn add_component(self: *const TuringerGameObject, component_type: Type) Component {
        const turing_result = _core_turinger_game_object__add_component(self.opaqu, component_type);
        return Component{ .opaqu = turing_result };
    }
    ...
    pub fn send_message_upwards(self: *const TuringerGameObject, method_name: []const u8, options: i32, allocator: std.mem.Allocator) !void {
        const turing_handle_method_name = try allocator.dupeZ(u8, method_name);
        defer allocator.free(turing_handle_method_name);
        _core_turinger_game_object__send_message_upwards(self.opaqu, turing_handle_method_name.ptr, options);
    }
    ...
    pub fn compare_tag(self: *const TuringerGameObject, tag: []const u8, allocator: std.mem.Allocator) bool {
        ...
        return _core_turinger_game_object__compare_tag(self.opaqu, turing_handle_tag.ptr);
    }
    ...
    pub fn tag_set(self: *const TuringerGameObject, value: []const u8, allocator: std.mem.Allocator) !void {
        ...
        _core_turinger_game_object__tag_set(self.opaqu, turing_handle_value.ptr);
    }
    ...
    pub fn get_component_at_index(self: *const TuringerGameObject, index: i32) Component {
        const turing_result = _core_turinger_game_object__get_component_at_index(self.opaqu, index);
        return Component{ .opaqu = turing_result };
    }


    pub fn tag_get(self: *const TuringerGameObject, allocator: std.mem.Allocator) ![]u8 {
        const turing_result = _core_turinger_game_object__tag_get(self.opaqu);
    ...
    pub fn name_get(self: *const TuringerGameObject, allocator: std.mem.Allocator) ![]u8 {
        const turing_result = _core_turinger_game_object__name_get(self.opaqu);
        const turing_str = try allocator.alloc(u8, turing_result);
        defer allocator.free(turing_str);
        _host_strcpy(turing_str.ptr, turing_result);
        const result = try allocator.dupe(u8, std.mem.span(@as([*:0]const u8, @ptrCast(turing_str.ptr))));
    ...
    pub fn get_component_by_type(self: *const TuringerGameObject, cs_type: Type) Component {
        const turing_result = _core_turinger_game_object__get_component_by_type(self.opaqu, cs_type);
        return Component{ .opaqu = turing_result };
    }
    ...
    pub fn get_component_by_name(self: *const TuringerGameObject, cs_type: []const u8, allocator: std.mem.Allocator) Component {
        ...
        const turing_result = _core_turinger_game_object__get_component_by_name(self.opaqu, turing_handle_cs_type.ptr);
        return Component{ .opaqu = turing_result };
    }
    ...
    pub fn name_set(self: *const TuringerGameObject, value: []const u8, allocator: std.mem.Allocator) !void {
        const turing_handle_value = try allocator.dupeZ(u8, value);
        defer allocator.free(turing_handle_value);
        _core_turinger_game_object__name_set(self.opaqu, turing_handle_value.ptr);
    }
...
pub const TuringerGameObjectManager = struct {
    ...
    pub fn create_object(name: []const u8, allocator: std.mem.Allocator) TuringerGameObject {
        ...
        const turing_result = _core_turinger_game_object_manager__create_object(turing_handle_name.ptr);
    ...
    pub fn find(name: []const u8, allocator: std.mem.Allocator) TuringerGameObject {
        const turing_handle_name = try allocator.dupeZ(u8, name);
        defer allocator.free(turing_handle_name);
        const turing_result = _core_turinger_game_object_manager__find(turing_handle_name.ptr);
        return TuringerGameObject{ .opaqu = turing_result };
    }
    ...
    pub fn instance_get(self: *const TuringerGameObjectManager) TuringerGameObjectManager {
        const turing_result = _core_turinger_game_object_manager__instance_get(self.opaqu);
...
pub const CustomData = struct {
    ...
    pub fn create() CustomData {
        const turing_result = _core_custom_data__create();
...
pub const GcHelper = struct {
    ...
    pub fn create() GCHelper {
        const turing_result = _core_gc_helper__create();
...
pub const Xr = struct {
    ...
    pub fn _manager_get(self: *const Xr) TuringScriptManager {
        const turing_result = _core_xr___manager_get(self.opaqu);
...
pub const TuringerTransform = struct {
    ...
    pub fn get_component_by_type(self: *const TuringerTransform, cs_type: Type) Component {
        const turing_result = _core_turinger_transform__get_component_by_type(self.opaqu, cs_type);
        return Component{ .opaqu = turing_result };
    }
    ...
    pub fn look_at(self: *const TuringerTransform, target: TuringerTransform, world_up: zalg.Vec3) void {
        ...
        _core_turinger_transform__look_at(self.opaqu, target, turing_handle_world_up);
    }
    ...
    pub fn tag_get(self: *const TuringerTransform, allocator: std.mem.Allocator) ![]u8 {
        const turing_result = _core_turinger_transform__tag_get(self.opaqu);
        const turing_str = try allocator.alloc(u8, turing_result);
        defer allocator.free(turing_str);
        _host_strcpy(turing_str.ptr, turing_result);
        const result = try allocator.dupe(u8, std.mem.span(@as([*:0]const u8, @ptrCast(turing_str.ptr))));
    ...
    pub fn local_euler_angles_get(self: *const TuringerTransform) zalg.Vec3 {
        _core_turinger_transform__local_euler_angles_get(self.opaqu);
        return dequeue_vec3();
    }


    pub fn rotation_get(self: *const TuringerTransform) zalg.Quat {
        _core_turinger_transform__rotation_get(self.opaqu);
        return dequeue_quat();
    }


    pub fn world_to_local_matrix_get(self: *const TuringerTransform) zalg.Mat4 {
        _core_turinger_transform__world_to_local_matrix_get(self.opaqu);
        return dequeue_mat4();
    }
    ...
    pub fn name_set(self: *const TuringerTransform, value: []const u8, allocator: std.mem.Allocator) !void {
        const turing_handle_value = try allocator.dupeZ(u8, value);
        defer allocator.free(turing_handle_value);
        _core_turinger_transform__name_set(self.opaqu, turing_handle_value.ptr);
    }


    pub fn local_rotation_get(self: *const TuringerTransform) zalg.Quat {
        _core_turinger_transform__local_rotation_get(self.opaqu);
        return dequeue_quat();
    }
    ...
    pub fn inverse_transform_point(self: *const TuringerTransform, position: zalg.Vec3) zalg.Vec3 {
        ...
        _core_turinger_transform__inverse_transform_point(self.opaqu, turing_handle_position);
        return dequeue_vec3();
    }


    pub fn get_component_in_children_by_type(self: *const TuringerTransform, t: Type, include_inactive: bool) Component {
        const turing_result = _core_turinger_transform__get_component_in_children_by_type(self.opaqu, t, include_inactive);
        return Component{ .opaqu = turing_result };
    }


    pub fn transform_get(self: *const TuringerTransform) Transform {
        const turing_result = _core_turinger_transform__transform_get(self.opaqu);
        return Transform{ .opaqu = turing_result };
    }


    pub fn lossy_scale_get(self: *const TuringerTransform) zalg.Vec3 {
        _core_turinger_transform__lossy_scale_get(self.opaqu);
        return dequeue_vec3();
    }


    pub fn root_get(self: *const TuringerTransform) TuringerTransform {
        const turing_result = _core_turinger_transform__root_get(self.opaqu);
        return TuringerTransform{ .opaqu = turing_result };
    }


    pub fn get_components_by_type(self: *const TuringerTransform, cs_type: Type) Component {
        const turing_result = _get_components_by_type(self.opaqu, cs_type);
        return Component{ .opaqu = turing_result };
    }
    ...
    pub fn get_enumerator(self: *const TuringerTransform) IEnumerator {
        const turing_result = _core_turinger_transform__get_enumerator(self.opaqu);
    ...
    pub fn local_scale_set(self: *const TuringerTransform, value: zalg.Vec3) void {
        ...
        _core_turinger_transform__local_scale_set(self.opaqu, turing_handle_value);
    }
    ...
    pub fn get_child(self: *const TuringerTransform, index: i32) TuringerTransform {
        const turing_result = _core_turinger_transform__get_child(self.opaqu, index);
        return TuringerTransform{ .opaqu = turing_result };
    }
    ...
    pub fn transform_direction(self: *const TuringerTransform, direction: zalg.Vec3) zalg.Vec3 {
        ...
        _core_turinger_transform__transform_direction(self.opaqu, turing_handle_direction);
        return dequeue_vec3();
    }
    ...
    pub fn send_message_upwards(self: *const TuringerTransform, method_name: []const u8, value: Object, options: i32, allocator: std.mem.Allocator) !void {
        const turing_handle_method_name = try allocator.dupeZ(u8, method_name);
        defer allocator.free(turing_handle_method_name);
        _core_turinger_transform__send_message_upwards(self.opaqu, turing_handle_method_name.ptr, value, options);
    }
    ...
    pub fn find_child(self: *const TuringerTransform, n: []const u8, allocator: std.mem.Allocator) TuringerTransform {
        ...
        const turing_result = _core_turinger_transform__find_child(self.opaqu, turing_handle_n.ptr);
        return TuringerTransform{ .opaqu = turing_result };
    }
    ...
    pub fn rotate(self: *const TuringerTransform, eulers: zalg.Vec3) void {
        ...
        _core_turinger_transform__rotate(self.opaqu, turing_handle_eulers);
    }
    ...
    pub fn local_position_get(self: *const TuringerTransform) zalg.Vec3 {
        _core_turinger_transform__local_position_get(self.opaqu);
        return dequeue_vec3();
    }
    ...
    pub fn translate_relative(self: *const TuringerTransform, translation: zalg.Vec3, relative_to: TuringerTransform) void {
        ...
        _core_turinger_transform__translate_relative(self.opaqu, turing_handle_translation, relative_to);
    }


    pub fn local_euler_angles_set(self: *const TuringerTransform, value: zalg.Vec3) void {
        const turing_handle_value = enqueue_vec3(value);
        _core_turinger_transform__local_euler_angles_set(self.opaqu, turing_handle_value);
    }
    ...
    pub fn set_local_position_and_rotation(self: *const TuringerTransform, local_position: zalg.Vec3, local_rotation: zalg.Quat) void {
        ...
        _core_turinger_transform__set_local_position_and_rotation(self.opaqu, turing_handle_local_position, turing_handle_local_rotation);
    }


    pub fn forward_get(self: *const TuringerTransform) zalg.Vec3 {
        _core_turinger_transform__forward_get(self.opaqu);
        return dequeue_vec3();
    }
    ...
    pub fn get_component_in_parent_by_type(self: *const TuringerTransform, t: Type, include_inactive: bool) Component {
        const turing_result = _core_turinger_transform__get_component_in_parent_by_type(self.opaqu, t, include_inactive);
        return Component{ .opaqu = turing_result };
    }


    pub fn up_get(self: *const TuringerTransform) zalg.Vec3 {
        _core_turinger_transform__up_get(self.opaqu);
        return dequeue_vec3();
    }
    ...
    pub fn rotate_around_local(self: *const TuringerTransform, axis: zalg.Vec3, angle: f32) void {
        ...
        _core_turinger_transform__rotate_around_local(self.opaqu, turing_handle_axis, angle);
    }


    pub fn translate(self: *const TuringerTransform, translation: zalg.Vec3, relative_to: i32) void {
        const turing_handle_translation = enqueue_vec3(translation);
        _core_turinger_transform__translate(self.opaqu, turing_handle_translation, relative_to);
    }
    ...
    pub fn broadcast_message(self: *const TuringerTransform, method_name: []const u8, parameter: Object, options: i32, allocator: std.mem.Allocator) !void {
        const turing_handle_method_name = try allocator.dupeZ(u8, method_name);
        defer allocator.free(turing_handle_method_name);
        _core_turinger_transform__broadcast_message(self.opaqu, turing_handle_method_name.ptr, parameter, options);
    }


    pub fn euler_angles_set(self: *const TuringerTransform, value: zalg.Vec3) void {
        const turing_handle_value = enqueue_vec3(value);
        _core_turinger_transform__euler_angles_set(self.opaqu, turing_handle_value);
    }
    ...
    pub fn send_message(self: *const TuringerTransform, method_name: []const u8, value: Object, options: i32, allocator: std.mem.Allocator) !void {
        const turing_handle_method_name = try allocator.dupeZ(u8, method_name);
        defer allocator.free(turing_handle_method_name);
        _core_turinger_transform__send_message(self.opaqu, turing_handle_method_name.ptr, value, options);
    }


    pub fn parent_get(self: *const TuringerTransform) TuringerTransform {
        const turing_result = _core_turinger_transform__parent_get(self.opaqu);
        return TuringerTransform{ .opaqu = turing_result };
    }


    pub fn local_to_world_matrix_get(self: *const TuringerTransform) zalg.Mat4 {
        _core_turinger_transform__local_to_world_matrix_get(self.opaqu);
        return dequeue_mat4();
    }
    ...
    pub fn get_component_by_name(self: *const TuringerTransform, cs_type: []const u8, allocator: std.mem.Allocator) Component {
        const turing_handle_cs_type = try allocator.dupeZ(u8, cs_type);
        defer allocator.free(turing_handle_cs_type);
        const turing_result = _core_turinger_transform__get_component_by_name(self.opaqu, turing_handle_cs_type.ptr);
        return Component{ .opaqu = turing_result };
    }


    pub fn set_parent(self: *const TuringerTransform, parent: TuringerTransform, world_position_stays: bool) void {
        _core_turinger_transform__set_parent(self.opaqu, parent, world_position_stays);
    }
    ...
    pub fn rotate_around(self: *const TuringerTransform, point: zalg.Vec3, axis: zalg.Vec3, angle: f32) void {
        ...
        const turing_handle_axis = enqueue_vec3(axis);
        _core_turinger_transform__rotate_around(self.opaqu, turing_handle_point, turing_handle_axis, angle);
    }
    ...
    pub fn up_set(self: *const TuringerTransform, value: zalg.Vec3) void {
        const turing_handle_value = enqueue_vec3(value);
        _core_turinger_transform__up_set(self.opaqu, turing_handle_value);
    }


    pub fn inverse_transform_direction(self: *const TuringerTransform, direction: zalg.Vec3) zalg.Vec3 {
        const turing_handle_direction = enqueue_vec3(direction);
        _core_turinger_transform__inverse_transform_direction(self.opaqu, turing_handle_direction);
        return dequeue_vec3();
    }


    pub fn local_scale_get(self: *const TuringerTransform) zalg.Vec3 {
        _core_turinger_transform__local_scale_get(self.opaqu);
        return dequeue_vec3();
    }
    ...
    pub fn transform_vector(self: *const TuringerTransform, vector: zalg.Vec3) zalg.Vec3 {
        ...
        _core_turinger_transform__transform_vector(self.opaqu, turing_handle_vector);
        return dequeue_vec3();
    }
    ...
    pub fn transform_point(self: *const TuringerTransform, position: zalg.Vec3) zalg.Vec3 {
        const turing_handle_position = enqueue_vec3(position);
        _core_turinger_transform__transform_point(self.opaqu, turing_handle_position);
        return dequeue_vec3();
    }


    pub fn euler_angles_get(self: *const TuringerTransform) zalg.Vec3 {
        _core_turinger_transform__euler_angles_get(self.opaqu);
        return dequeue_vec3();
    }
    ...
    pub fn right_set(self: *const TuringerTransform, value: zalg.Vec3) void {
        const turing_handle_value = enqueue_vec3(value);
        _core_turinger_transform__right_set(self.opaqu, turing_handle_value);
    }
    ...
    pub fn rotate_relative(self: *const TuringerTransform, eulers: zalg.Vec3, relative_to: i32) void {
        const turing_handle_eulers = enqueue_vec3(eulers);
        _core_turinger_transform__rotate_relative(self.opaqu, turing_handle_eulers, relative_to);
    }


    pub fn rotation_set(self: *const TuringerTransform, value: zalg.Quat) void {
        const turing_handle_value = enqueue_quat(value);
        _core_turinger_transform__rotation_set(self.opaqu, turing_handle_value);
    }


    pub fn game_object_get(self: *const TuringerTransform) TuringerGameObject {
        const turing_result = _core_turinger_transform__game_object_get(self.opaqu);
        return TuringerGameObject{ .opaqu = turing_result };
    }
    ...
    pub fn right_get(self: *const TuringerTransform) zalg.Vec3 {
        _core_turinger_transform__right_get(self.opaqu);
        return dequeue_vec3();
    }
    ...
    pub fn local_position_set(self: *const TuringerTransform, value: zalg.Vec3) void {
        const turing_handle_value = enqueue_vec3(value);
        _core_turinger_transform__local_position_set(self.opaqu, turing_handle_value);
    }


    pub fn forward_set(self: *const TuringerTransform, value: zalg.Vec3) void {
        const turing_handle_value = enqueue_vec3(value);
        _core_turinger_transform__forward_set(self.opaqu, turing_handle_value);
    }


    pub fn name_get(self: *const TuringerTransform, allocator: std.mem.Allocator) ![]u8 {
        const turing_result = _core_turinger_transform__name_get(self.opaqu);
        const turing_str = try allocator.alloc(u8, turing_result);
        defer allocator.free(turing_str);
        _host_strcpy(turing_str.ptr, turing_result);
        const result = try allocator.dupe(u8, std.mem.span(@as([*:0]const u8, @ptrCast(turing_str.ptr))));
    ...
    pub fn compare_tag(self: *const TuringerTransform, tag: []const u8, allocator: std.mem.Allocator) bool {
        const turing_handle_tag = try allocator.dupeZ(u8, tag);
        defer allocator.free(turing_handle_tag);
        return _core_turinger_transform__compare_tag(self.opaqu, turing_handle_tag.ptr);
    }
    ...
    pub fn position_get(self: *const TuringerTransform) zalg.Vec3 {
        _core_turinger_transform__position_get(self.opaqu);
        return dequeue_vec3();
    }
    ...
    pub fn position_set(self: *const TuringerTransform, value: zalg.Vec3) void {
        const turing_handle_value = enqueue_vec3(value);
        _core_turinger_transform__position_set(self.opaqu, turing_handle_value);
    }
    ...
    pub fn set_position_and_rotation(self: *const TuringerTransform, position: zalg.Vec3, rotation: zalg.Quat) void {
        ...
        _core_turinger_transform__set_position_and_rotation(self.opaqu, turing_handle_position, turing_handle_rotation);
    }
    ...
    pub fn find(self: *const TuringerTransform, n: []const u8, allocator: std.mem.Allocator) TuringerTransform {
        const turing_handle_n = try allocator.dupeZ(u8, n);
        defer allocator.free(turing_handle_n);
        const turing_result = _core_turinger_transform__find(self.opaqu, turing_handle_n.ptr);
        return TuringerTransform{ .opaqu = turing_result };
    }
    ...
    pub fn tag_set(self: *const TuringerTransform, value: []const u8, allocator: std.mem.Allocator) !void {
        const turing_handle_value = try allocator.dupeZ(u8, value);
        defer allocator.free(turing_handle_value);
        _core_turinger_transform__tag_set(self.opaqu, turing_handle_value.ptr);
    }


    pub fn local_rotation_set(self: *const TuringerTransform, value: zalg.Quat) void {
        const turing_handle_value = enqueue_quat(value);
        _core_turinger_transform__local_rotation_set(self.opaqu, turing_handle_value);
    }


    pub fn inverse_transform_vector(self: *const TuringerTransform, vector: zalg.Vec3) zalg.Vec3 {
        const turing_handle_vector = enqueue_vec3(vector);
        _core_turinger_transform__inverse_transform_vector(self.opaqu, turing_handle_vector);
        return dequeue_vec3();
    }
